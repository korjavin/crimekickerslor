---
aliases: [Series Arc, Show Arc, Season One Arc, Episode Plan]
tags: [story, arc, draft, proposal]
canon: proposal
status: draft
season: 1
---

# Series Arc — Season One

The shape of the comic. Builds on [[Origin & Concept]] (canon) and proposes a
specific path through it: **origin → diaspora → reunion → antagonist**.

> **Status:** Spark draft, Editor-reconciled, **author-ratified 2026-06-14**.
> Items in the "Canon resolutions" table below were promoted to canon on that
> date. Episode beats and structure remain proposal until each issue is
> individually approved.

## Format

Each episode is a **comic issue of 4–6 panels** (one page, occasionally a
two-page spread for splash moments). One image per panel, tight captions,
minimal dialogue. Iconography over blocking. Episode descriptions below are
panel budgets and intent — not scripts.
...
The cyborg of [[Origin & Concept]] — **Project AEGIS-4** — was a prototype for
...
> the *Lunch Lady* and the *Prototype* are in the same building. They are
> co-workers.

The series is the story of how they accidentally become a team anyway.

## Act structure (Season 1)
...
### Act III — Reunion (Issues 6–8, ~5 panels each)
The fragments start running into each other, **two at a time**, in messy
unplanned ways. Each meeting is a small case-of-the-week with a *"wait, do I
...
### Act IV — Antagonist reveal (Issues 9–10, ~5–6 panels each)
**GastroDefense Inc.** comes looking for its missing prototype. The fragments
discover they were not the only AEGIS model planned. Season ends with the
...
- Comedic-absurd, per [[Origin & Concept]] — but the early episodes lean
  **lonely-funny** rather than slapstick-funny. The slapstick scales up as the
  team comes together.
- The corporation is **soulless, not menacing.** Evil by quarterly report, not
  by monologue. RoboCop's OCP is the closest reference.
- The lunch lady is **not** a villain. She is a force of nature with a ladle.

## Canon resolutions (ratified 2026-06-14)

These were promoted from proposal to canon in the author session on
2026-06-14. They supersede earlier registry phrasing where they conflict.

| Resolved question | Canon |
| --- | --- |
...
The **~40 prior comic issues** ("Issue forty-one") are *not* reconciled by this
arc — the show and the comics are treated as parallel timelines unless the
author rules otherwise.

## Open design questions

- ~~The corporation's name.~~ **Locked: GastroDefense Inc.** Working tagline:
  *"Hot meals, cold justice."* (the one used on the Issue 1 poster).
  Alternates parked: *"Keeping the public safe to consume."* ·
  *"From kitchen to crime scene."*
- ~~Prototype codename.~~ **Locked: Project AEGIS-4.**
- Does the Lunch Lady recur? (Spark vote: yes — recurring legend, **one word
  per season**, always the right word. Issue 1's word: *"Settle."*)
- Does the **Junior Engineer** recur as the show's "person who knows"? (Spark
  vote: yes — the only human who saw the split, future recurring POV.)
- Do the fragments know they were ever one being? (Spark vote: **no**, and
  the audience does. Central dramatic irony for the diaspora arc.)
- Is the fracture **reversible**? (Spark vote: no — the fragments could in
  theory reassemble, but doing so would *un-make* the four selves. This is
  the series' final-act moral question.)

## Related

- [[Origin & Concept]] · [[The Crime Kickers]] · [[The Bad Guys]]
- [[S01E01 — Some Assembly Required]]
