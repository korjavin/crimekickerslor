---
aliases: [S01E07 Panel Prompts, Specific Heat Prompts]
...
# S01E07 — Panel Prompts

Image-generation prompts and episode-specific visual canon for
[[S01E07 — Specific Heat]] (Primm + Pho-boman, the second reunion episode). Built by
the **panel-prompt-smith** agent.

> Each prompt is **self-contained** — image models have no memory, so every prompt
> restates the art style, the characters, and the props in full. The global art style
...
suited in every panel** — the equipment crystallized at split-time, so he is never
partially-suited, never unmasked. Reuse this descriptor block **verbatim** in every
panel (scaled to camera distance and pose):
...
- **Always fully suited (load-bearing guard).** In every panel the **dark purple coat,
  the glowing cyan visor, the twin ninjato-style blades sheathed on his back, and the
  orbiting faint-blue mini-orbs** are present. Never render him partially-suited,
...
spoon silhouette and belly dragon are already revealed canon (full reveal landed in
[[S01E04 — Panel Prompts]] Panel 4), so here he is **shown in full from the first panel
he appears in** — no withhold. Reuse this descriptor block **verbatim** in every panel:
...
- **Belly emblem (verbatim):** *a large red Chinese dragon on a blue background, scales
  and claws detailed, tail wrapping around the belly.* Reuse this exact wording wherever
  the belly is in view.
- **The visor IS the face / mouth.** He has no mouth. In P4 the gloved palm seal goes
  **across the open visor**; in P5 the SLURP and the reforming face happen **inside the
  open visor**. Never draw a separate mouth, and never invent any helmet hardware,
  rim-gasket, or seal — the open visor is the existing mechanism.
- **The broth-thickening clock (P2–P3).** As the cold bites, the reddish-orange broth
  shifts toward the visor's lower rim, slows, thickens; the noodle-eyes contract toward
  each other; the cilantro nose stiffens. He is never panicked — render this as a slow,
  deliberate stiffening, not distress.

### Gravity-field light-bend VFX, and the blocked-field beat (verbatim from [[S01E05 — Panel Prompts]] + this episode)
...
This episode's recurring VFX beat is that **the light-bend STOPS DEAD at steel** — it
does not propagate through the racking. Reuse this wording wherever the field meets a
steel rack or the steel-subframe floor:

> where the gravity light-bend distortion reaches a steel surface (a rack column, a
> shelf, the steel-subframed floor), the distortion ENDS FLAT against the metal and
> bounces back toward him — it does NOT pass through the steel, does NOT ripple the far
> side, does NOT find the wall behind it; the field's edge is visibly clipped off at the
> metal, blocked

### Teleport / blink VFX (P3, dissolves without completing)

Per [[Primm]] Power VFX (teleport leaves faint glowing blue trails); in this issue every
blink-vector passes through steel and fails:

> faint glowing blue teleport blink-trails that flicker and DISSOLVE WITHOUT COMPLETING

### Body-field on Pho-boman / zero-g broth (P4 only)

In P4 Primm applies the DRIFT field to Pho-boman's **whole body** (an established
arm's-reach capability, a new target — not a discovery), and the broth inside the helmet
goes weightless. Reuse this block in P4:

> the gravity light-bend distortion wraps the small spoon-shaped being's ENTIRE body in
> one contained field, from helmet to boots — only him, not the room, not the walls;
> inside the transparent visor the reddish-orange broth goes WEIGHTLESS and lifts free
> of the visor's lower bowl, the noodle-eyes drift apart and float independent, the
> cilantro nose rises from center and hovers, and the whole noodle-and-broth face
> dissolves into a suspended cloud of floating soup particles and drifting noodles in
> zero gravity inside the helmet — a face that is momentarily not a face

The seal that keeps the weightless broth inside the open visor is **Primm's flat gloved
palm pressed across the visor gap** — his existing black silver-fingertip glove, nothing
else. Reuse:

> his black gloved hand, silver fingertips, is pressed FLAT across the open visor gap of
> the diving helmet, fingers spread, the glove itself sealing the opening so nothing
> escapes outward — the seal is the flat gloved palm, NOT any rim, gasket, hatch or
> helmet hardware

### The SLURP / face-reform beat (P5 only)

His canonical SFX from [[Pho-boman]] is **SLURP**. At the doorframe gravity returns, the
field ends, the broth crashes back, the face reforms:

> as the gravity field ends at the doorframe and gravity returns, the reddish-orange
> broth crashes back DOWN into the visor's lower bowl, the noodle-eyes drop into
> position, the cilantro nose falls back to center, the face REFORMS and the broth
> settles, fluid again — the warmest, loudest beat after the freezer's near-silence

### The GastroDefense cold-storage loading dock (P1)

The corporate antagonist's logistics yard, exterior, night. Reuse for the dock in P1:

> a GastroDefense Inc. cold-storage logistics loading dock at NIGHT — a wide bare
> concrete apron under cold blue-black darkness, a heavy insulated steel freezer door at
> the far end, sodium-dim and institutional; dark grey-blue-black palette, no warm
> street light

- **The refrigerated truck (P1 only):** *a parked GastroDefense Inc. refrigerated
...
The contained stage for four of the five panels. Reuse this block for the freezer
interior in P2–P5:

> the interior of a walk-in industrial freezer, roughly eight by six meters, rated
> −18°C: floor-to-ceiling STEEL racking on all four walls and across most of the floor,
> frosted bare metal uprights and shelves, every surface bloomed with ice crystals and
> hoarfrost, cold vapor and breath-fog hanging in the air; the palette is dark
> institutional GREY-BLUE, frozen metal, no warm light anywhere in the room itself

- **Frozen broth shipments (set dressing, P2–P4):** *commercial catering tubs of frozen
  broth stacked on the steel shelves, plain institutional GastroDefense logistics
  labels.* Background only; never a warm pop (they are frozen and lidded).
- **The 1.5 m non-steel gap / exit corridor (planted P3, run P5):** *a single
  one-and-a-half-meter-wide gap between two rack columns at the far end, the only
  non-steel corridor in the room, running from the center of the floor straight to the
  exit door.* In P3 it is a quiet background plant; in P5 it is the run.

### The "two warm pops" rule (every panel)

The freezer and the dock stay **dark institutional grey-blue**. The **only** two warm or
saturated color notes in any panel are **Pho-boman's reddish-orange pho broth** (always)
and **Primm's cyan visor-glow** (plus his faint-blue mini-orbs / gravity light-bend, the
cool counterpart to the broth's warmth, and his dark purple coat). Always add the
negative "no warm or saturated lighting on the room — only the reddish-orange broth and
the cyan visor / blue orbs / purple coat carry color."
...
noodle-eyes / noodle-brows, the green cilantro nose, **no separate mouth**, the
red-dragon belly emblem; **no purple ninja suit, no cyan visor, no katanas** on him. The
DRIFT light-bend **stops dead at steel** wherever it meets the racking (it never passes
through metal). GastroDefense appears **only as a logo / labels**, never as an active
speaking character. The episode **ends on two figures in the freezer doorway facing the
same outward direction** — never one figure leaving alone.
...
>
> IN THE BACKGROUND, between two rack columns at the far end of the freezer, easy to miss: a single one-and-a-half-meter-wide GAP between the racks, the only non-steel corridor in the room, running from the center of the floor straight to the closed exit door — visible but NOT pointed to, a quiet plant the reader can find.
>
...
- The irony of a gravity manipulator steadying himself on a steel upright is staged but
  **never captioned** — the image carries it.

### Panel 4 — The Face Goes Away For A Moment

> **The pivot — the twist, the emotional beat, and the cooperative act in one frame.**
> Primm has crossed to Pho-boman and pressed one gloved palm FLAT ACROSS THE OPEN VISOR as
> a seal. The DRIFT field fires from that contact and wraps Pho-boman's whole body — not
> the room. Inside the helmet the broth goes weightless: the noodle-face dissolves into a
> suspended cloud of floating soup and drifting noodles. Pho-boman lifts, weightless, mildly
> bewildered. Primm's mini-orbs snap to tight orbit; he has gone still one beat too long.

**Style anchor:** [[Visual Style Guide|v1]]. **Palette override:** freezer interior —
dark institutional grey-blue, frosted steel, cold vapor; the reddish-orange broth (now
dissolving in zero-g inside the visor) and the cyan visor / blue orbs / gravity
light-bend / purple coat the only warm/cool pops. **Reveal:** CLOSE-WIDE — gloved palm
sealing the open visor, body-field wrapping Pho-boman, zero-g dissolved face inside the
helmet.
...
> Modern Western graphic-novel comic-book illustration, single comic-page panel. Clean confident hand-inked black linework with medium-weight uniform outlines and selective heavier contour lines, light cross-hatching for shadow. Flat cel-style coloring with subtle cell-shading gradients, limited halftone texture, restrained screen-tone dot shading in shadows. Slightly stylized semi-realistic proportions, expressive readable faces, deadpan comedic timing. Crisp print-quality finish, clear silhouette-first staging, strong readable composition, no photorealism, no 3D render look. Muted desaturated naturalistic palette as the project baseline.
>
> CLOSE-WIDE shot, eye-level, intimate and quiet, inside the interior of a walk-in industrial freezer rated −18°C: frosted floor-to-ceiling STEEL racking and ice-crystal bloom behind the two figures, cold vapor in the air; the palette is dark institutional GREY-BLUE, frozen metal, no warm light anywhere in the room itself. The two heroes fill the frame.
>
> ON THE LEFT, having crossed to the smaller figure: a slim, lean humanoid man, male, ~175–180 cm tall, built for agile blinking and gravity poses; a slightly elongated face with sharp focused eyes and short-to-medium dark brown hair, wearing high-tech goggles with faintly blue-tinted transparent lenses behind a glowing CYAN visor; a sleek lab-coat-style jacket in DARK PURPLE with silver trim, open at the front; a black undershirt with faint glowing blue lines in a subtle geometric pattern; dark-blue fitted trousers tucked into black boots with silver accents; black gloves with silver fingertips; small metallic mini-orbs that ORBIT his chest and waist, glowing faint blue; and twin katanas (ninjato-style straight blades) sheathed flat across his back. His expression behind the cyan visor does NOT change register — calm, exact, a being who made a calculation and is watching the result. His mini-orbs are in a TIGHT, disciplined, evenly-spaced orbit — not erratic, tight, the way they orbit when he has the answer.
>
> THE SEAL: his black gloved hand, silver fingertips, is pressed FLAT across the open visor gap of the other figure's diving helmet, fingers spread, the glove itself sealing the opening so nothing escapes outward — the seal is the flat gloved palm, NOT any rim, gasket, hatch or helmet hardware.
>
> THE OTHER FIGURE, held at the helmet, lifted and weightless: a small round spoon-shaped being, the smallest hero at roughly 140–150 cm tall, with a large round belly bearing a large red Chinese dragon on a blue background (scales and claws detailed, tail wrapping the belly), short legs nearly hidden under the belly's curve, and short but noticeably muscular arms; his head is shaped like a deep-sea diving helmet — a wide metal dome with a wide transparent front visor; he has NO separate mouth — the open visor simply shows the soup, and the visor IS the face; he wears short black pants and fully black, flat, minimalist boots. His short arms float slightly upward and his black boots are no longer planted — he is effectively WEIGHTLESS, held by Primm's grip at the helmet, feet barely above the floor. His posture reads as mild bewilderment, not panic.
>
> THE BODY-FIELD AND THE ZERO-G FACE: the gravity light-bend distortion wraps the small spoon-shaped being's ENTIRE body in one contained field, from helmet to boots — only him, not the room, not the walls; inside the transparent visor (visible to the reader through the glass above and around Primm's covering palm) the reddish-orange broth goes WEIGHTLESS and lifts free of the visor's lower bowl, the noodle-eyes drift apart and float independent, the cilantro nose rises from center and hovers, and the whole noodle-and-broth face dissolves into a suspended cloud of floating soup particles and drifting noodles in zero gravity inside the helmet — a face that is momentarily not a face. Primm's palm across the visor keeps everything inside; nothing escapes outward.
>
> Primm looks at the dissolved face through the visor glass, palm still flat against it, and has gone STILL — one beat too long, before the run.
>
> The reddish-orange weightless broth dissolving inside the visor and the cyan visor-glow, the faint-blue tight-orbiting mini-orbs, the cool gravity light-bend wrapping the small being, and the dark purple coat are the ONLY warm or saturated colors in the otherwise dark grey-blue frozen room.
>
> Composition: silhouette-first, the tall purple-coated man on the left with his flat gloved palm sealing the open visor of the small weightless spoon-being on the right, the cool gravity light-bend wrapping only the small being's whole body, the reddish-orange noodle-and-broth face dissolved into a suspended zero-g cloud inside the transparent helmet as the strange focal image, the frozen grey-blue steel racking behind. Very still, a little strange, not explained. One small SFX in plain comic lettering, quiet and integrated into the light-bend field wrapping the small being (smaller than a shout): "DRIFT—". Then four small dry caption boxes in plain comic lettering, case-file register, staircase rhythm: "The broth went weightless." / "The face went away for a moment." / "He looked at it." / "It felt like a word in a language he had not yet learned."

**NEGATIVE PROMPT**

> exactly TWO heroes (the tall purple-coated man and the small spoon-being — NO third hero, NO fourth, NO other figures), the man is FULLY suited — always the DARK PURPLE coat, the glowing CYAN visor, the twin ninjato-style blades sheathed on his back, and the orbiting faint-blue mini-orbs (NOT partially-suited, NOT unmasked), his blades stay SHEATHED (not drawn, not swung), his mini-orbs are in TIGHT disciplined orbit (NOT scattered, NOT erratic), the SEAL across the open visor is his FLAT GLOVED PALM (silver fingertips, fingers spread) and NOTHING ELSE — do NOT invent any rim-seal, gasket, hatch, lid, clamp, or new helmet hardware (the open visor is the existing mechanism, sealed only by the palm), the gravity light-bend wraps ONLY the small being's whole body (NOT the room, NOT the walls, NOT the floor), inside the visor the broth is WEIGHTLESS and the noodle-face has DISSOLVED into a suspended zero-g cloud of floating soup and drifting noodles (NOT a settled face, NOT a normal face, NOT a drawn mouth — he has no mouth), the small being is WEIGHTLESS and lifted, feet barely above the floor, mildly bewildered NOT panicking, the man's expression does NOT change register (calm, exact, not shocked, not emotional), no broth escapes outward past the palm, no third hero, no team name or super-team logo, no cape, no flight, no eye bandage, no folding fan (Windman), no French beret, no mustard shirt (Tiebi), the man has no diving helmet/pho/broth/noodles/red-dragon belly; the spoon-being has no purple ninja suit/cyan visor/katanas, no manga or anime style, no chibi, no 3D render, no photorealism, no modern smartphones, no anachronistic gadgets, no extra fingers, no malformed hands, no extra limbs, no text errors or garbled lettering (other than the four intended captions and the intended subtle "DRIFT—" SFX), no warm or saturated lighting across the room (only the reddish-orange dissolving broth and the cyan visor / blue orbs / gravity light-bend / purple coat carry color).

**Consistency notes**

- Both heroes reused **verbatim**. Primm's **mini-orbs snap to tight orbit** here (the
  answer-state, carried from [[S01E05 — Panel Prompts]] P4); his expression does **not**
  change register.
- **The seal is the flat gloved palm across the open visor — nothing else.** No invented
  rim-seal, gasket, hatch, or helmet hardware. The existing black silver-fingertip glove
  is the physical seal; guarded hard in the negative. This is the single most important
  on-model guard in the panel.
- **The body-field is on Pho-boman, not the room** (an established arm's-reach capability,
  a new target — not a discovery). The zero-g dissolved noodle-and-broth face is the
  episode's most unusual image; the panel holds it, contained inside the transparent visor.
- The emotional beat is Primm's alone and **one-directional** — "a word in a language he
  had not yet learned," not recognition. Pho-boman reads as mild bewilderment, not panic.
  Kept exactly to the script's register; no editorializing in-image.

### Panel 5 — That Was The Whole Plan
...
flooding out through the open door; the reddish-orange broth (resettling, SLURP) and the
cyan visor / blue orbs / purple coat the only warm/cool pops. **Reveal:** TWO FIGURES IN
THE DOORWAY, facing the same outward direction; broth resettled, mini-orbs in tight orbit.
...
>
> GRAVITY RETURNS AT THE DOORFRAME: as the gravity field ends at the doorframe and gravity returns, the reddish-orange broth crashes back DOWN into the visor's lower bowl, the noodle-eyes drop into position, the cilantro nose falls back to center, the face REFORMS and the broth settles, fluid again — the warmest, loudest beat after the freezer's near-silence. His visor-face is back, upright and resettled.
>
> BOTH FIGURES FACE THE SAME DIRECTION — outward through the open door, toward the dim loading dock and the city beyond, cold vapor dissipating around them. NEITHER is looking at the other. The frozen freezer is behind them; they are not looking at it.
>
...
- Both heroes reused **verbatim**. Primm's **mini-orbs in tight orbit** (answer-state held
  from P4); Pho-boman's **face reformed and broth resettled** at the doorframe as gravity
  returns — the inverse of P4's dissolution.
- **The SLURP** is the episode's loudest, warmest beat after five panels of near-silence,
  riding the broth crashing back into the visor — kept bold per the script.
- **The doorway ending grammar (load-bearing seam):** exactly two figures, half-in/half-out,
...
- [[S01E07 — Specific Heat]] — the script these prompts render.
- [[S01E06 — Panel Prompts]] · [[S01E05 — Panel Prompts]] · [[S01E04 — Panel Prompts]] ·
  [[S01E03 — Panel Prompts]] · [[S01E02 — Panel Prompts]] · [[S01E01 — Panel Prompts]] —
  format template; Art-Style Anchor v1 reused verbatim; the gravity light-bend VFX, the
  mini-orb state signature, and the Pho-boman descriptor block are reused verbatim from the
  E05 (Primm) and E04 (Pho-boman) prompt sets.
- [[S01E06 — Two-Body Problem]] — established the two-figure doorway ending grammar (P6)
  that P5 honors and continues; established the incident-signature against which this
  episode's absence-of-signal (the FIELD READ "broth-type") is defined.
- [[S01E05 — Hold Your Own Weight]] — established the DRIFT SFX, the gravity light-bend VFX,
  the diagnostic narrow-focus register, and the metal-mass vulnerability (cable tray)
  activated fully here.
- [[S01E04 — What Is a Ladle For]] — established SLURP, the open-visor-is-the-mouth rule,
  and the cold vulnerability plant, activated here.
- [[Visual Style Guide]] — global art-style anchor and recurring descriptors.
- [[Primm]] — single source of truth for his appearance, power VFX, SFX (DRIFT), and the
  locked blade descriptor "katanas (ninjato-style straight blades)".
- [[Pho-boman]] — single source of truth for his appearance, SFX (SLURP), and the
  open-visor-is-the-face rule.
